        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{route('user.subscription.plan')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Subscription plan
                    ...
                    <li class="nav-item">
                        <a href="{{route('user.credit.plan')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Credit plan
                    ...
                    <li class="nav-item">
                        <a href="{{route('user.email.download')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Email Download
                    ...
                    <li class="nav-item">
                        <a href="{{route('user.billing')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Billing
