            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModal">Create New Plan</button>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteplan{{$plan->id}}"><i class="fas fa-trash"></i> </button>
                            </td>
                        </tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{route('admin.subscription.plan.delete')}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="col-md-12">
                                            are you sure to delete this plan ?
                                            <input type="hidden" class="form-control" name="plan_delete_id" value="{{$plan->id}}">
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade" id="editplan{{$plan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('admin.subscription.plan.update')}}" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="col-md-12">
                                                <label>Plan Name</label>
                                                <input type="text" class="form-control" name="plan_name" value="{{$plan->plan_name}}">
                                                <input type="hidden" class="form-control" name="plan_edit_id" value="{{$plan->id}}">
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea type="text" class="form-control" name="plan_description">{!! $plan->plan_description !!}</textarea>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-control" name="plan_status">
                                                    ...
                                                    <option value="1" {{$plan->plan_status == 1 ?'selected' : ''}}>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.subscription.plan.save')}}" method="post">
                    @csrf
                <div class="modal-body">
                    <div class="col-md-12">
                        <label>Plan Name</label>
                    ...
                    <div class="col-md-12">
                        <label>Plan Description</label>
                        <textarea type="text" class="form-control" name="plan_description"></textarea>
                    </div>
                    <div class="col-md-12">
                        <label>Plan Status</label>
                        <select class="form-control" name="plan_status">
